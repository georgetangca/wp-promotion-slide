...
if ( ! defined( 'PROMOSLIDER_PLUGIN_BASENAME' ) )
	define( 'PROMOSLIDER_PLUGIN_BASENAME', plugin_basename( __FILE__ ) );

if ( ! defined( 'PROMOSLIDER_PLUGIN_NAME' ) )
	define( 'PROMOSLIDER_PLUGIN_NAME', trim( dirname( PROMOSLIDER_PLUGIN_BASENAME ), '/' ) );

if ( ! defined( 'PROMOSLIDER_PLUGIN_URL' ) )
	define( 'PROMOSLIDER_PLUGIN_URL', WP_PLUGIN_URL . '/' . PROMOSLIDER_PLUGIN_NAME );
...
if( !class_exists('promo_slider') ){
	...
	class promo_slider{
		...
		function admin_menu(){
			// Create options page
                       //george change here for not show the option page  
		...
		function get_slider_thumb( $title ){
                       //$return_result = '<img width="10" height="10" src="'.PROMOSLIDER_PLUGIN_URL.'/css/images/green.jpg" class="attachment-thumbnail wp-post-image" title="'.$title.'" />';
                       $return_result = '<img class="attachment-thumbnail wp-post-image" title="'.$title.'" />';
